...
session_start();
    echo "<h1 style='color:#e6e6ff;text-align:center;text-transform:uppercase;font-family:cursive;'>WELCOME"."&emsp;";
     echo $_SESSION['name']."&emsp;"."!!!";   
       echo "</h1>";
?>

        <div id="link">
      <a href="add_pack.php" style="padding: 15px;"><b>ADD PACKAGE</b></a>
      <a href="pack_details.php" style="padding: 15px;"><b>PACKAGE DETAILS</b></a>
            <a href="passenger.php" style="padding: 15px;"><b>PASSENGER DETAILS</b></a>
        </div>
